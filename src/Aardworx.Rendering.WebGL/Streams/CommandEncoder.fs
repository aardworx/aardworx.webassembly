...
type CommandEncoder(device : Device) =
    ...
    abstract GetActiveAttrib : ``program`` : uint32 * ``index`` : uint32 * ``bufSize`` : uint32 * ``length`` : nativeptr<uint32> * ``size`` : nativeptr<int> * ``type`` : nativeptr<AttributeType> * ``name`` : nativeptr<uint8> -> unit
    abstract GetActiveAttrib : ``program`` : aptr<uint32> * ``index`` : aptr<uint32> * ``bufSize`` : aptr<uint32> * ``length`` : aptr<uint32> * ``size`` : aptr<int> * ``type`` : aptr<AttributeType> * ``name`` : aptr<uint8> -> unit
    ...
    abstract GetTransformFeedbackVarying : ``program`` : uint32 * ``index`` : uint32 * ``bufSize`` : uint32 * ``length`` : nativeptr<uint32> * ``size`` : nativeptr<uint32> * ``type`` : nativeptr<AttributeType> * ``name`` : nativeptr<uint8> -> unit
    abstract GetTransformFeedbackVarying : ``program`` : aptr<uint32> * ``index`` : aptr<uint32> * ``bufSize`` : aptr<uint32> * ``length`` : aptr<uint32> * ``size`` : aptr<uint32> * ``type`` : aptr<AttributeType> * ``name`` : aptr<uint8> -> unit
