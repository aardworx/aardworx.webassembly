...
module internal GLDelegates =
    ...
    [<SuppressUnmanagedCodeSecurity>]
    type glGetActiveAttribDelegate = delegate of ``program`` : uint32 * ``index`` : uint32 * ``bufSize`` : uint32 * ``length`` : nativeptr<uint32> * ``size`` : nativeptr<int> * ``type`` : nativeptr<AttributeType> * ``name`` : nativeptr<uint8> -> unit
    [<SuppressUnmanagedCodeSecurity>]
    ...
    [<SuppressUnmanagedCodeSecurity>]
    type glGetTransformFeedbackVaryingDelegate = delegate of ``program`` : uint32 * ``index`` : uint32 * ``bufSize`` : uint32 * ``length`` : nativeptr<uint32> * ``size`` : nativeptr<uint32> * ``type`` : nativeptr<AttributeType> * ``name`` : nativeptr<uint8> -> unit
    [<SuppressUnmanagedCodeSecurity>]
...
type ManagedCommandEncoder(device : Device) =
    ...
    override this.Uniform3f(``location`` : int, ``v0`` : float32, ``v1`` : float32, ``v2`` : float32) = 
        commands.Add <| fun () -> gl.glUniform3f.Invoke(``location``, ``v0``, ``v1``, ``v2``)
    override this.Uniform3f(``location`` : aptr<int>, ``v0`` : aptr<float32>, ``v1`` : aptr<float32>, ``v2`` : aptr<float32>) = 
        let ``location`` = this.Use ``location``
        let ``v0`` = this.Use ``v0``
        let ``v1`` = this.Use ``v1``
        let ``v2`` = this.Use ``v2``
        commands.Add <| fun () -> gl.glUniform3f.Invoke(``location``.Value, ``v0``.Value, ``v1``.Value, ``v2``.Value)
    ...
    override this.Uniform4f(``location`` : int, ``v0`` : float32, ``v1`` : float32, ``v2`` : float32, ``v3`` : float32) = 
        commands.Add <| fun () -> gl.glUniform4f.Invoke(``location``, ``v0``, ``v1``, ``v2``, ``v3``)
    override this.Uniform4f(``location`` : aptr<int>, ``v0`` : aptr<float32>, ``v1`` : aptr<float32>, ``v2`` : aptr<float32>, ``v3`` : aptr<float32>) = 
        ...
        let ``v2`` = this.Use ``v2``
        let ``v3`` = this.Use ``v3``
        commands.Add <| fun () -> gl.glUniform4f.Invoke(``location``.Value, ``v0``.Value, ``v1``.Value, ``v2``.Value, ``v3``.Value)
    ...
    override this.VertexAttrib1f(``index`` : uint32, ``x`` : float32) = 
        commands.Add <| fun () -> gl.glVertexAttrib1f.Invoke(``index``, ``x``)
    override this.VertexAttrib1f(``index`` : aptr<uint32>, ``x`` : aptr<float32>) = 
        let ``index`` = this.Use ``index``
        let ``x`` = this.Use ``x``
        commands.Add <| fun () -> gl.glVertexAttrib1f.Invoke(``index``.Value, ``x``.Value)
    ...
    override this.VertexAttrib2f(``index`` : uint32, ``x`` : float32, ``y`` : float32) = 
        commands.Add <| fun () -> gl.glVertexAttrib2f.Invoke(``index``, ``x``, ``y``)
    override this.VertexAttrib2f(``index`` : aptr<uint32>, ``x`` : aptr<float32>, ``y`` : aptr<float32>) = 
        let ``index`` = this.Use ``index``
        let ``x`` = this.Use ``x``
        let ``y`` = this.Use ``y``
        commands.Add <| fun () -> gl.glVertexAttrib2f.Invoke(``index``.Value, ``x``.Value, ``y``.Value)
    ...
    override this.VertexAttrib3f(``index`` : uint32, ``x`` : float32, ``y`` : float32, ``z`` : float32) = 
        commands.Add <| fun () -> gl.glVertexAttrib3f.Invoke(``index``, ``x``, ``y``, ``z``)
    override this.VertexAttrib3f(``index`` : aptr<uint32>, ``x`` : aptr<float32>, ``y`` : aptr<float32>, ``z`` : aptr<float32>) = 
        let ``index`` = this.Use ``index``
        let ``x`` = this.Use ``x``
        let ``y`` = this.Use ``y``
        let ``z`` = this.Use ``z``
        commands.Add <| fun () -> gl.glVertexAttrib3f.Invoke(``index``.Value, ``x``.Value, ``y``.Value, ``z``.Value)
    ...
    override this.VertexAttrib4f(``index`` : uint32, ``x`` : float32, ``y`` : float32, ``z`` : float32, ``w`` : float32) = 
        commands.Add <| fun () -> gl.glVertexAttrib4f.Invoke(``index``, ``x``, ``y``, ``z``, ``w``)
    override this.VertexAttrib4f(``index`` : aptr<uint32>, ``x`` : aptr<float32>, ``y`` : aptr<float32>, ``z`` : aptr<float32>, ``w`` : aptr<float32>) = 
        ...
        let ``z`` = this.Use ``z``
        let ``w`` = this.Use ``w``
        commands.Add <| fun () -> gl.glVertexAttrib4f.Invoke(``index``.Value, ``x``.Value, ``y``.Value, ``z``.Value, ``w``.Value)
    ...
    override this.TexImage2D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``width`` : uint32, ``height`` : uint32, ``border`` : int, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        commands.Add <| fun () -> gl.glTexImage2D.Invoke(``target``, ``level``, ``internalformat``, ``width``, ``height``, ``border``, ``format``, ``type``, ``pixels``)
    override this.TexImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``border`` : aptr<int>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<nativeint>) = 
        ...
        commands.Add <| fun () -> gl.glTexImage2D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``width``.Value, ``height``.Value, ``border``.Value, ``format``.Value, ``type``.Value, ``pixels``.Value)
    override this.TexParameterf(``target`` : TextureTarget, ``pname`` : TextureParameterName, ``param`` : float32) = 
        commands.Add <| fun () -> gl.glTexParameterf.Invoke(``target``, ``pname``, ``param``)
    override this.TexParameterf(``target`` : aptr<TextureTarget>, ``pname`` : aptr<TextureParameterName>, ``param`` : aptr<float32>) = 
        ...
        commands.Add <| fun () -> gl.glTexParameterf.Invoke(``target``.Value, ``pname``.Value, ``param``.Value)
    ...
    override this.TexSubImage2D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``width`` : uint32, ``height`` : uint32, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        commands.Add <| fun () -> gl.glTexSubImage2D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``width``, ``height``, ``format``, ``type``, ``pixels``)
    override this.TexSubImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<nativeint>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``pixels`` = this.Use ``pixels``
        commands.Add <| fun () -> gl.glTexSubImage2D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``width``.Value, ``height``.Value, ``format``.Value, ``type``.Value, ``pixels``.Value)
    override this.Uniform1f(``location`` : int, ``v0`` : float32) = 
        commands.Add <| fun () -> gl.glUniform1f.Invoke(``location``, ``v0``)
    override this.Uniform1f(``location`` : aptr<int>, ``v0`` : aptr<float32>) = 
        let ``location`` = this.Use ``location``
        let ``v0`` = this.Use ``v0``
        commands.Add <| fun () -> gl.glUniform1f.Invoke(``location``.Value, ``v0``.Value)
    ...
    override this.Uniform2f(``location`` : int, ``v0`` : float32, ``v1`` : float32) = 
        commands.Add <| fun () -> gl.glUniform2f.Invoke(``location``, ``v0``, ``v1``)
    override this.Uniform2f(``location`` : aptr<int>, ``v0`` : aptr<float32>, ``v1`` : aptr<float32>) = 
        let ``location`` = this.Use ``location``
        let ``v0`` = this.Use ``v0``
        let ``v1`` = this.Use ``v1``
        commands.Add <| fun () -> gl.glUniform2f.Invoke(``location``.Value, ``v0``.Value, ``v1``.Value)
    ...
    override this.ReadPixels(``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        commands.Add <| fun () -> gl.glReadPixels.Invoke(``x``, ``y``, ``width``, ``height``, ``format``, ``type``, ``pixels``)
    override this.ReadPixels(``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<'T7>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``pixels`` = this.Use ``pixels``
        commands.Add <| fun () -> gl.glReadPixels.Invoke(``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value, ``format``.Value, ``type``.Value, ``pixels``.Pointer)
    ...
    override this.SampleCoverage(``value`` : float32, ``invert`` : Boolean) = 
        commands.Add <| fun () -> gl.glSampleCoverage.Invoke(``value``, ``invert``)
    override this.SampleCoverage(``value`` : aptr<float32>, ``invert`` : aptr<Boolean>) = 
        let ``value`` = this.Use ``value``
        let ``invert`` = this.Use ``invert``
        commands.Add <| fun () -> gl.glSampleCoverage.Invoke(``value``.Value, ``invert``.Value)
    ...
    override this.LineWidth(``width`` : float32) = 
        commands.Add <| fun () -> gl.glLineWidth.Invoke(``width``)
    override this.LineWidth(``width`` : aptr<float32>) = 
        let ``width`` = this.Use ``width``
        commands.Add <| fun () -> gl.glLineWidth.Invoke(``width``.Value)
    ...
    override this.PolygonOffset(``factor`` : float32, ``units`` : float32) = 
        commands.Add <| fun () -> gl.glPolygonOffset.Invoke(``factor``, ``units``)
    override this.PolygonOffset(``factor`` : aptr<float32>, ``units`` : aptr<float32>) = 
        let ``factor`` = this.Use ``factor``
        let ``units`` = this.Use ``units``
        commands.Add <| fun () -> gl.glPolygonOffset.Invoke(``factor``.Value, ``units``.Value)
    override this.GetActiveUniform(``program`` : uint32, ``index`` : uint32, ``bufSize`` : uint32, ``length`` : nativeptr<uint32>, ``size`` : nativeptr<int>, ``type`` : nativeptr<GLEnum>, ``name`` : nativeptr<uint8>) = 
        commands.Add <| fun () -> gl.glGetActiveUniform.Invoke(``program``, ``index``, ``bufSize``, ``length``, ``size``, ``type``, ``name``)
    override this.GetActiveUniform(``program`` : aptr<uint32>, ``index`` : aptr<uint32>, ``bufSize`` : aptr<uint32>, ``length`` : aptr<uint32>, ``size`` : aptr<int>, ``type`` : aptr<GLEnum>, ``name`` : aptr<uint8>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``name`` = this.Use ``name``
        commands.Add <| fun () -> gl.glGetActiveUniform.Invoke(``program``.Value, ``index``.Value, ``bufSize``.Value, NativePtr.ofNativeInt ``length``.Pointer, NativePtr.ofNativeInt ``size``.Pointer, NativePtr.ofNativeInt ``type``.Pointer, NativePtr.ofNativeInt ``name``.Pointer)
    ...
    override this.GetActiveAttrib(``program`` : uint32, ``index`` : uint32, ``bufSize`` : uint32, ``length`` : nativeptr<uint32>, ``size`` : nativeptr<int>, ``type`` : nativeptr<AttributeType>, ``name`` : nativeptr<uint8>) = 
        commands.Add <| fun () -> gl.glGetActiveAttrib.Invoke(``program``, ``index``, ``bufSize``, ``length``, ``size``, ``type``, ``name``)
    override this.GetActiveAttrib(``program`` : aptr<uint32>, ``index`` : aptr<uint32>, ``bufSize`` : aptr<uint32>, ``length`` : aptr<uint32>, ``size`` : aptr<int>, ``type`` : aptr<AttributeType>, ``name`` : aptr<uint8>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``name`` = this.Use ``name``
        commands.Add <| fun () -> gl.glGetActiveAttrib.Invoke(``program``.Value, ``index``.Value, ``bufSize``.Value, NativePtr.ofNativeInt ``length``.Pointer, NativePtr.ofNativeInt ``size``.Pointer, NativePtr.ofNativeInt ``type``.Pointer, NativePtr.ofNativeInt ``name``.Pointer)
    ...
    override this.DepthRangef(``n`` : float32, ``f`` : float32) = 
        commands.Add <| fun () -> gl.glDepthRangef.Invoke(``n``, ``f``)
    override this.DepthRangef(``n`` : aptr<float32>, ``f`` : aptr<float32>) = 
        let ``n`` = this.Use ``n``
        let ``f`` = this.Use ``f``
        commands.Add <| fun () -> gl.glDepthRangef.Invoke(``n``.Value, ``f``.Value)
    ...
    override this.ClearColor(``red`` : float32, ``green`` : float32, ``blue`` : float32, ``alpha`` : float32) = 
        commands.Add <| fun () -> gl.glClearColor.Invoke(``red``, ``green``, ``blue``, ``alpha``)
    override this.ClearColor(``red`` : aptr<float32>, ``green`` : aptr<float32>, ``blue`` : aptr<float32>, ``alpha`` : aptr<float32>) = 
        ...
        commands.Add <| fun () -> gl.glClearColor.Invoke(``red``.Value, ``green``.Value, ``blue``.Value, ``alpha``.Value)
    override this.ClearDepthf(``d`` : float32) = 
        commands.Add <| fun () -> gl.glClearDepthf.Invoke(``d``)
    override this.ClearDepthf(``d`` : aptr<float32>) = 
        let ``d`` = this.Use ``d``
        commands.Add <| fun () -> gl.glClearDepthf.Invoke(``d``.Value)
    ...
    override this.CompressedTexImage2D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``width`` : uint32, ``height`` : uint32, ``border`` : int, ``imageSize`` : uint32, ``data`` : nativeint) = 
        commands.Add <| fun () -> gl.glCompressedTexImage2D.Invoke(``target``, ``level``, ``internalformat``, ``width``, ``height``, ``border``, ``imageSize``, ``data``)
    override this.CompressedTexImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``border`` : aptr<int>, ``imageSize`` : aptr<uint32>, ``data`` : aptr<nativeint>) = 
        ...
        let ``data`` = this.Use ``data``
        commands.Add <| fun () -> gl.glCompressedTexImage2D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``width``.Value, ``height``.Value, ``border``.Value, ``imageSize``.Value, ``data``.Value)
    override this.CompressedTexSubImage2D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``width`` : uint32, ``height`` : uint32, ``format`` : InternalFormat, ``imageSize`` : uint32, ``data`` : nativeint) = 
        commands.Add <| fun () -> gl.glCompressedTexSubImage2D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``width``, ``height``, ``format``, ``imageSize``, ``data``)
    override this.CompressedTexSubImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``format`` : aptr<InternalFormat>, ``imageSize`` : aptr<uint32>, ``data`` : aptr<nativeint>) = 
        ...
        let ``imageSize`` = this.Use ``imageSize``
        let ``data`` = this.Use ``data``
        commands.Add <| fun () -> gl.glCompressedTexSubImage2D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``width``.Value, ``height``.Value, ``format``.Value, ``imageSize``.Value, ``data``.Value)
    override this.CopyTexImage2D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32, ``border`` : int) = 
        commands.Add <| fun () -> gl.glCopyTexImage2D.Invoke(``target``, ``level``, ``internalformat``, ``x``, ``y``, ``width``, ``height``, ``border``)
    override this.CopyTexImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``border`` : aptr<int>) = 
        ...
        let ``height`` = this.Use ``height``
        let ``border`` = this.Use ``border``
        commands.Add <| fun () -> gl.glCopyTexImage2D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value, ``border``.Value)
    override this.CopyTexSubImage2D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32) = 
        commands.Add <| fun () -> gl.glCopyTexSubImage2D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``x``, ``y``, ``width``, ``height``)
    override this.CopyTexSubImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>) = 
        ...
        let ``width`` = this.Use ``width``
        let ``height`` = this.Use ``height``
        commands.Add <| fun () -> gl.glCopyTexSubImage2D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value)
    ...
    override this.BlendColor(``red`` : float32, ``green`` : float32, ``blue`` : float32, ``alpha`` : float32) = 
        commands.Add <| fun () -> gl.glBlendColor.Invoke(``red``, ``green``, ``blue``, ``alpha``)
    override this.BlendColor(``red`` : aptr<float32>, ``green`` : aptr<float32>, ``blue`` : aptr<float32>, ``alpha`` : aptr<float32>) = 
        let ``red`` = this.Use ``red``
        let ``green`` = this.Use ``green``
        let ``blue`` = this.Use ``blue``
        let ``alpha`` = this.Use ``alpha``
        commands.Add <| fun () -> gl.glBlendColor.Invoke(``red``.Value, ``green``.Value, ``blue``.Value, ``alpha``.Value)
    ...
    override this.SamplerParameterf(``sampler`` : uint32, ``pname`` : SamplerParameterF, ``param`` : float32) = 
        commands.Add <| fun () -> gl.glSamplerParameterf.Invoke(``sampler``, ``pname``, ``param``)
    override this.SamplerParameterf(``sampler`` : aptr<uint32>, ``pname`` : aptr<SamplerParameterF>, ``param`` : aptr<float32>) = 
        let ``sampler`` = this.Use ``sampler``
        let ``pname`` = this.Use ``pname``
        let ``param`` = this.Use ``param``
        commands.Add <| fun () -> gl.glSamplerParameterf.Invoke(``sampler``.Value, ``pname``.Value, ``param``.Value)
    ...
    override this.TexImage3D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``width`` : uint32, ``height`` : uint32, ``depth`` : uint32, ``border`` : int, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        commands.Add <| fun () -> gl.glTexImage3D.Invoke(``target``, ``level``, ``internalformat``, ``width``, ``height``, ``depth``, ``border``, ``format``, ``type``, ``pixels``)
    override this.TexImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``depth`` : aptr<uint32>, ``border`` : aptr<int>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<nativeint>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``pixels`` = this.Use ``pixels``
        commands.Add <| fun () -> gl.glTexImage3D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``width``.Value, ``height``.Value, ``depth``.Value, ``border``.Value, ``format``.Value, ``type``.Value, ``pixels``.Value)
    ...
    override this.TexSubImage3D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``zoffset`` : int, ``width`` : uint32, ``height`` : uint32, ``depth`` : uint32, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        commands.Add <| fun () -> gl.glTexSubImage3D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``zoffset``, ``width``, ``height``, ``depth``, ``format``, ``type``, ``pixels``)
    override this.TexSubImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``zoffset`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``depth`` : aptr<uint32>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<nativeint>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``pixels`` = this.Use ``pixels``
        commands.Add <| fun () -> gl.glTexSubImage3D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``zoffset``.Value, ``width``.Value, ``height``.Value, ``depth``.Value, ``format``.Value, ``type``.Value, ``pixels``.Value)
    override this.GetTransformFeedbackVarying(``program`` : uint32, ``index`` : uint32, ``bufSize`` : uint32, ``length`` : nativeptr<uint32>, ``size`` : nativeptr<uint32>, ``type`` : nativeptr<AttributeType>, ``name`` : nativeptr<uint8>) = 
        commands.Add <| fun () -> gl.glGetTransformFeedbackVarying.Invoke(``program``, ``index``, ``bufSize``, ``length``, ``size``, ``type``, ``name``)
    override this.GetTransformFeedbackVarying(``program`` : aptr<uint32>, ``index`` : aptr<uint32>, ``bufSize`` : aptr<uint32>, ``length`` : aptr<uint32>, ``size`` : aptr<uint32>, ``type`` : aptr<AttributeType>, ``name`` : aptr<uint8>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``name`` = this.Use ``name``
        commands.Add <| fun () -> gl.glGetTransformFeedbackVarying.Invoke(``program``.Value, ``index``.Value, ``bufSize``.Value, NativePtr.ofNativeInt ``length``.Pointer, NativePtr.ofNativeInt ``size``.Pointer, NativePtr.ofNativeInt ``type``.Pointer, NativePtr.ofNativeInt ``name``.Pointer)
    ...
    override this.InvalidateSubFramebuffer(``target`` : FramebufferTarget, ``numAttachments`` : uint32, ``attachments`` : nativeptr<GLEnum>, ``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32) = 
        commands.Add <| fun () -> gl.glInvalidateSubFramebuffer.Invoke(``target``, ``numAttachments``, ``attachments``, ``x``, ``y``, ``width``, ``height``)
    override this.InvalidateSubFramebuffer(``target`` : aptr<FramebufferTarget>, ``numAttachments`` : aptr<uint32>, ``attachments`` : aptr<GLEnum>, ``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>) = 
        ...
        let ``width`` = this.Use ``width``
        let ``height`` = this.Use ``height``
        commands.Add <| fun () -> gl.glInvalidateSubFramebuffer.Invoke(``target``.Value, ``numAttachments``.Value, NativePtr.ofNativeInt ``attachments``.Pointer, ``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value)
    ...
    override this.BlitFramebuffer(``srcX0`` : int, ``srcY0`` : int, ``srcX1`` : int, ``srcY1`` : int, ``dstX0`` : int, ``dstY0`` : int, ``dstX1`` : int, ``dstY1`` : int, ``mask`` : ClearBufferMask, ``filter`` : BlitFramebufferFilter) = 
        commands.Add <| fun () -> gl.glBlitFramebuffer.Invoke(``srcX0``, ``srcY0``, ``srcX1``, ``srcY1``, ``dstX0``, ``dstY0``, ``dstX1``, ``dstY1``, ``mask``, ``filter``)
    override this.BlitFramebuffer(``srcX0`` : aptr<int>, ``srcY0`` : aptr<int>, ``srcX1`` : aptr<int>, ``srcY1`` : aptr<int>, ``dstX0`` : aptr<int>, ``dstY0`` : aptr<int>, ``dstX1`` : aptr<int>, ``dstY1`` : aptr<int>, ``mask`` : aptr<ClearBufferMask>, ``filter`` : aptr<BlitFramebufferFilter>) = 
        ...
        commands.Add <| fun () -> gl.glBlitFramebuffer.Invoke(``srcX0``.Value, ``srcY0``.Value, ``srcX1``.Value, ``srcY1``.Value, ``dstX0``.Value, ``dstY0``.Value, ``dstX1``.Value, ``dstY1``.Value, ``mask``.Value, ``filter``.Value)
    ...
    override this.ClearBufferfi(``buffer`` : BufferKind, ``drawbuffer`` : int, ``depth`` : float32, ``stencil`` : int) = 
        commands.Add <| fun () -> gl.glClearBufferfi.Invoke(``buffer``, ``drawbuffer``, ``depth``, ``stencil``)
    override this.ClearBufferfi(``buffer`` : aptr<BufferKind>, ``drawbuffer`` : aptr<int>, ``depth`` : aptr<float32>, ``stencil`` : aptr<int>) = 
        ...
        commands.Add <| fun () -> gl.glClearBufferfi.Invoke(``buffer``.Value, ``drawbuffer``.Value, ``depth``.Value, ``stencil``.Value)
    ...
    override this.CompressedTexImage3D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``width`` : uint32, ``height`` : uint32, ``depth`` : uint32, ``border`` : int, ``imageSize`` : uint32, ``data`` : nativeint) = 
        commands.Add <| fun () -> gl.glCompressedTexImage3D.Invoke(``target``, ``level``, ``internalformat``, ``width``, ``height``, ``depth``, ``border``, ``imageSize``, ``data``)
    override this.CompressedTexImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``depth`` : aptr<uint32>, ``border`` : aptr<int>, ``imageSize`` : aptr<uint32>, ``data`` : aptr<nativeint>) = 
        ...
        let ``imageSize`` = this.Use ``imageSize``
        let ``data`` = this.Use ``data``
        commands.Add <| fun () -> gl.glCompressedTexImage3D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``width``.Value, ``height``.Value, ``depth``.Value, ``border``.Value, ``imageSize``.Value, ``data``.Value)
    override this.CompressedTexSubImage3D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``zoffset`` : int, ``width`` : uint32, ``height`` : uint32, ``depth`` : uint32, ``format`` : InternalFormat, ``imageSize`` : uint32, ``data`` : nativeint) = 
        commands.Add <| fun () -> gl.glCompressedTexSubImage3D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``zoffset``, ``width``, ``height``, ``depth``, ``format``, ``imageSize``, ``data``)
    override this.CompressedTexSubImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``zoffset`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``depth`` : aptr<uint32>, ``format`` : aptr<InternalFormat>, ``imageSize`` : aptr<uint32>, ``data`` : aptr<nativeint>) = 
        ...
        let ``imageSize`` = this.Use ``imageSize``
        let ``data`` = this.Use ``data``
        commands.Add <| fun () -> gl.glCompressedTexSubImage3D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``zoffset``.Value, ``width``.Value, ``height``.Value, ``depth``.Value, ``format``.Value, ``imageSize``.Value, ``data``.Value)
    ...
    override this.CopyTexSubImage3D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``zoffset`` : int, ``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32) = 
        commands.Add <| fun () -> gl.glCopyTexSubImage3D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``zoffset``, ``x``, ``y``, ``width``, ``height``)
    override this.CopyTexSubImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``zoffset`` : aptr<int>, ``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>) = 
        ...
        let ``width`` = this.Use ``width``
        let ``height`` = this.Use ``height``
        commands.Add <| fun () -> gl.glCopyTexSubImage3D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``zoffset``.Value, ``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value)
...
type internal ImmediateCommandEncoder(device : Device, currentGL : GL) =
    ...
    override this.Uniform3f(``location`` : int, ``v0`` : float32, ``v1`` : float32, ``v2`` : float32) = 
        gl.glUniform3f.Invoke(``location``, ``v0``, ``v1``, ``v2``)
    override this.Uniform3f(``location`` : aptr<int>, ``v0`` : aptr<float32>, ``v1`` : aptr<float32>, ``v2`` : aptr<float32>) = 
        this.Acquire ``location``
        this.Acquire ``v0``
        this.Acquire ``v1``
        this.Acquire ``v2``
        gl.glUniform3f.Invoke(``location``.Value, ``v0``.Value, ``v1``.Value, ``v2``.Value)
    override this.Uniform3fv(``location`` : int, ``count`` : uint32, ``value`` : nativeptr<float32>) = 
    ...
    override this.Uniform4f(``location`` : int, ``v0`` : float32, ``v1`` : float32, ``v2`` : float32, ``v3`` : float32) = 
        gl.glUniform4f.Invoke(``location``, ``v0``, ``v1``, ``v2``, ``v3``)
    override this.Uniform4f(``location`` : aptr<int>, ``v0`` : aptr<float32>, ``v1`` : aptr<float32>, ``v2`` : aptr<float32>, ``v3`` : aptr<float32>) = 
        this.Acquire ``location``
        this.Acquire ``v0``
        this.Acquire ``v1``
        this.Acquire ``v2``
        this.Acquire ``v3``
        gl.glUniform4f.Invoke(``location``.Value, ``v0``.Value, ``v1``.Value, ``v2``.Value, ``v3``.Value)
    override this.Uniform4fv(``location`` : int, ``count`` : uint32, ``value`` : nativeptr<float32>) = 
    ...
    override this.VertexAttrib1f(``index`` : uint32, ``x`` : float32) = 
        gl.glVertexAttrib1f.Invoke(``index``, ``x``)
    override this.VertexAttrib1f(``index`` : aptr<uint32>, ``x`` : aptr<float32>) = 
        this.Acquire ``index``
        this.Acquire ``x``
        gl.glVertexAttrib1f.Invoke(``index``.Value, ``x``.Value)
    override this.VertexAttrib1fv(``index`` : uint32, ``v`` : nativeptr<float32>) = 
    ...
    override this.VertexAttrib2f(``index`` : uint32, ``x`` : float32, ``y`` : float32) = 
        gl.glVertexAttrib2f.Invoke(``index``, ``x``, ``y``)
    override this.VertexAttrib2f(``index`` : aptr<uint32>, ``x`` : aptr<float32>, ``y`` : aptr<float32>) = 
        this.Acquire ``index``
        this.Acquire ``x``
        this.Acquire ``y``
        gl.glVertexAttrib2f.Invoke(``index``.Value, ``x``.Value, ``y``.Value)
    override this.VertexAttrib2fv(``index`` : uint32, ``v`` : nativeptr<float32>) = 
    ...
    override this.VertexAttrib3f(``index`` : uint32, ``x`` : float32, ``y`` : float32, ``z`` : float32) = 
        gl.glVertexAttrib3f.Invoke(``index``, ``x``, ``y``, ``z``)
    override this.VertexAttrib3f(``index`` : aptr<uint32>, ``x`` : aptr<float32>, ``y`` : aptr<float32>, ``z`` : aptr<float32>) = 
        this.Acquire ``index``
        this.Acquire ``x``
        this.Acquire ``y``
        this.Acquire ``z``
        gl.glVertexAttrib3f.Invoke(``index``.Value, ``x``.Value, ``y``.Value, ``z``.Value)
    override this.VertexAttrib3fv(``index`` : uint32, ``v`` : nativeptr<float32>) = 
    ...
    override this.VertexAttrib4f(``index`` : uint32, ``x`` : float32, ``y`` : float32, ``z`` : float32, ``w`` : float32) = 
        gl.glVertexAttrib4f.Invoke(``index``, ``x``, ``y``, ``z``, ``w``)
    override this.VertexAttrib4f(``index`` : aptr<uint32>, ``x`` : aptr<float32>, ``y`` : aptr<float32>, ``z`` : aptr<float32>, ``w`` : aptr<float32>) = 
        this.Acquire ``index``
        this.Acquire ``x``
        this.Acquire ``y``
        this.Acquire ``z``
        this.Acquire ``w``
        gl.glVertexAttrib4f.Invoke(``index``.Value, ``x``.Value, ``y``.Value, ``z``.Value, ``w``.Value)
    override this.VertexAttrib4fv(``index`` : uint32, ``v`` : nativeptr<float32>) = 
    ...
    override this.TexImage2D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``width`` : uint32, ``height`` : uint32, ``border`` : int, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        gl.glTexImage2D.Invoke(``target``, ``level``, ``internalformat``, ``width``, ``height``, ``border``, ``format``, ``type``, ``pixels``)
    override this.TexImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``border`` : aptr<int>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<nativeint>) = 
        this.Acquire ``target``
        this.Acquire ``level``
        ...
        this.Acquire ``type``
        this.Acquire ``pixels``
        gl.glTexImage2D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``width``.Value, ``height``.Value, ``border``.Value, ``format``.Value, ``type``.Value, ``pixels``.Value)
    override this.TexParameterf(``target`` : TextureTarget, ``pname`` : TextureParameterName, ``param`` : float32) = 
        gl.glTexParameterf.Invoke(``target``, ``pname``, ``param``)
    override this.TexParameterf(``target`` : aptr<TextureTarget>, ``pname`` : aptr<TextureParameterName>, ``param`` : aptr<float32>) = 
        this.Acquire ``target``
        this.Acquire ``pname``
        this.Acquire ``param``
        gl.glTexParameterf.Invoke(``target``.Value, ``pname``.Value, ``param``.Value)
    override this.TexParameterfv(``target`` : TextureTarget, ``pname`` : TextureParameterName, ``params`` : nativeptr<float32>) = 
    ...
    override this.TexSubImage2D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``width`` : uint32, ``height`` : uint32, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        gl.glTexSubImage2D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``width``, ``height``, ``format``, ``type``, ``pixels``)
    override this.TexSubImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<nativeint>) = 
        this.Acquire ``target``
        this.Acquire ``level``
        ...
        this.Acquire ``type``
        this.Acquire ``pixels``
        gl.glTexSubImage2D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``width``.Value, ``height``.Value, ``format``.Value, ``type``.Value, ``pixels``.Value)
    override this.Uniform1f(``location`` : int, ``v0`` : float32) = 
        gl.glUniform1f.Invoke(``location``, ``v0``)
    override this.Uniform1f(``location`` : aptr<int>, ``v0`` : aptr<float32>) = 
        this.Acquire ``location``
        this.Acquire ``v0``
        gl.glUniform1f.Invoke(``location``.Value, ``v0``.Value)
    override this.Uniform1fv(``location`` : int, ``count`` : uint32, ``value`` : nativeptr<float32>) = 
    ...
    override this.Uniform2f(``location`` : int, ``v0`` : float32, ``v1`` : float32) = 
        gl.glUniform2f.Invoke(``location``, ``v0``, ``v1``)
    override this.Uniform2f(``location`` : aptr<int>, ``v0`` : aptr<float32>, ``v1`` : aptr<float32>) = 
        this.Acquire ``location``
        this.Acquire ``v0``
        this.Acquire ``v1``
        gl.glUniform2f.Invoke(``location``.Value, ``v0``.Value, ``v1``.Value)
    override this.Uniform2fv(``location`` : int, ``count`` : uint32, ``value`` : nativeptr<float32>) = 
    ...
    override this.ReadPixels(``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        gl.glReadPixels.Invoke(``x``, ``y``, ``width``, ``height``, ``format``, ``type``, ``pixels``)
    override this.ReadPixels(``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<'T7>) = 
        this.Acquire ``x``
        this.Acquire ``y``
        this.Acquire ``width``
        ...
        this.Acquire ``type``
        this.Acquire ``pixels``
        gl.glReadPixels.Invoke(``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value, ``format``.Value, ``type``.Value, ``pixels``.Pointer)
    override this.ReleaseShaderCompiler() = 
    ...
    override this.SampleCoverage(``value`` : float32, ``invert`` : Boolean) = 
        gl.glSampleCoverage.Invoke(``value``, ``invert``)
    override this.SampleCoverage(``value`` : aptr<float32>, ``invert`` : aptr<Boolean>) = 
        this.Acquire ``value``
        this.Acquire ``invert``
        gl.glSampleCoverage.Invoke(``value``.Value, ``invert``.Value)
    override this.Scissor(``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32) = 
    ...
    override this.LineWidth(``width`` : float32) = 
        gl.glLineWidth.Invoke(``width``)
    override this.LineWidth(``width`` : aptr<float32>) = 
        this.Acquire ``width``
        gl.glLineWidth.Invoke(``width``.Value)
    override this.LinkProgram(``program`` : uint32) = 
    ...
    override this.PolygonOffset(``factor`` : float32, ``units`` : float32) = 
        gl.glPolygonOffset.Invoke(``factor``, ``units``)
    override this.PolygonOffset(``factor`` : aptr<float32>, ``units`` : aptr<float32>) = 
        this.Acquire ``factor``
        this.Acquire ``units``
        gl.glPolygonOffset.Invoke(``factor``.Value, ``units``.Value)
    override this.GetActiveUniform(``program`` : uint32, ``index`` : uint32, ``bufSize`` : uint32, ``length`` : nativeptr<uint32>, ``size`` : nativeptr<int>, ``type`` : nativeptr<GLEnum>, ``name`` : nativeptr<uint8>) = 
        gl.glGetActiveUniform.Invoke(``program``, ``index``, ``bufSize``, ``length``, ``size``, ``type``, ``name``)
    override this.GetActiveUniform(``program`` : aptr<uint32>, ``index`` : aptr<uint32>, ``bufSize`` : aptr<uint32>, ``length`` : aptr<uint32>, ``size`` : aptr<int>, ``type`` : aptr<GLEnum>, ``name`` : aptr<uint8>) = 
        this.Acquire ``program``
        this.Acquire ``index``
        this.Acquire ``bufSize``
        ...
        this.Acquire ``type``
        this.Acquire ``name``
        gl.glGetActiveUniform.Invoke(``program``.Value, ``index``.Value, ``bufSize``.Value, NativePtr.ofNativeInt ``length``.Pointer, NativePtr.ofNativeInt ``size``.Pointer, NativePtr.ofNativeInt ``type``.Pointer, NativePtr.ofNativeInt ``name``.Pointer)
    override this.GetAttachedShaders(``program`` : uint32, ``maxCount`` : uint32, ``count`` : nativeptr<uint32>, ``shaders`` : nativeptr<uint32>) = 
    ...
    override this.GetActiveAttrib(``program`` : uint32, ``index`` : uint32, ``bufSize`` : uint32, ``length`` : nativeptr<uint32>, ``size`` : nativeptr<int>, ``type`` : nativeptr<AttributeType>, ``name`` : nativeptr<uint8>) = 
        gl.glGetActiveAttrib.Invoke(``program``, ``index``, ``bufSize``, ``length``, ``size``, ``type``, ``name``)
    override this.GetActiveAttrib(``program`` : aptr<uint32>, ``index`` : aptr<uint32>, ``bufSize`` : aptr<uint32>, ``length`` : aptr<uint32>, ``size`` : aptr<int>, ``type`` : aptr<AttributeType>, ``name`` : aptr<uint8>) = 
        this.Acquire ``program``
        this.Acquire ``index``
        this.Acquire ``bufSize``
        ...
        this.Acquire ``type``
        this.Acquire ``name``
        gl.glGetActiveAttrib.Invoke(``program``.Value, ``index``.Value, ``bufSize``.Value, NativePtr.ofNativeInt ``length``.Pointer, NativePtr.ofNativeInt ``size``.Pointer, NativePtr.ofNativeInt ``type``.Pointer, NativePtr.ofNativeInt ``name``.Pointer)
    override this.DeleteBuffers(``n`` : uint32, ``buffers`` : nativeptr<uint32>) = 
    ...
    override this.DepthRangef(``n`` : float32, ``f`` : float32) = 
        gl.glDepthRangef.Invoke(``n``, ``f``)
    override this.DepthRangef(``n`` : aptr<float32>, ``f`` : aptr<float32>) = 
        this.Acquire ``n``
        this.Acquire ``f``
        gl.glDepthRangef.Invoke(``n``.Value, ``f``.Value)
    override this.DetachShader(``program`` : uint32, ``shader`` : uint32) = 
    ...
    override this.ClearColor(``red`` : float32, ``green`` : float32, ``blue`` : float32, ``alpha`` : float32) = 
        gl.glClearColor.Invoke(``red``, ``green``, ``blue``, ``alpha``)
    override this.ClearColor(``red`` : aptr<float32>, ``green`` : aptr<float32>, ``blue`` : aptr<float32>, ``alpha`` : aptr<float32>) = 
        this.Acquire ``red``
        this.Acquire ``green``
        this.Acquire ``blue``
        this.Acquire ``alpha``
        gl.glClearColor.Invoke(``red``.Value, ``green``.Value, ``blue``.Value, ``alpha``.Value)
    override this.ClearDepthf(``d`` : float32) = 
        gl.glClearDepthf.Invoke(``d``)
    override this.ClearDepthf(``d`` : aptr<float32>) = 
        this.Acquire ``d``
        gl.glClearDepthf.Invoke(``d``.Value)
    override this.ClearStencil(``s`` : int) = 
    ...
    override this.CompressedTexImage2D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``width`` : uint32, ``height`` : uint32, ``border`` : int, ``imageSize`` : uint32, ``data`` : nativeint) = 
        gl.glCompressedTexImage2D.Invoke(``target``, ``level``, ``internalformat``, ``width``, ``height``, ``border``, ``imageSize``, ``data``)
    override this.CompressedTexImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``border`` : aptr<int>, ``imageSize`` : aptr<uint32>, ``data`` : aptr<nativeint>) = 
        this.Acquire ``target``
        this.Acquire ``level``
        this.Acquire ``internalformat``
        ...
        this.Acquire ``data``
        gl.glCompressedTexImage2D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``width``.Value, ``height``.Value, ``border``.Value, ``imageSize``.Value, ``data``.Value)
    override this.CompressedTexSubImage2D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``width`` : uint32, ``height`` : uint32, ``format`` : InternalFormat, ``imageSize`` : uint32, ``data`` : nativeint) = 
        gl.glCompressedTexSubImage2D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``width``, ``height``, ``format``, ``imageSize``, ``data``)
    override this.CompressedTexSubImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``format`` : aptr<InternalFormat>, ``imageSize`` : aptr<uint32>, ``data`` : aptr<nativeint>) = 
        this.Acquire ``target``
        this.Acquire ``level``
        this.Acquire ``xoffset``
        ...
        this.Acquire ``imageSize``
        this.Acquire ``data``
        gl.glCompressedTexSubImage2D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``width``.Value, ``height``.Value, ``format``.Value, ``imageSize``.Value, ``data``.Value)
    override this.CopyTexImage2D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32, ``border`` : int) = 
        gl.glCopyTexImage2D.Invoke(``target``, ``level``, ``internalformat``, ``x``, ``y``, ``width``, ``height``, ``border``)
    override this.CopyTexImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``border`` : aptr<int>) = 
        this.Acquire ``target``
        this.Acquire ``level``
        this.Acquire ``internalformat``
        ...
        this.Acquire ``height``
        this.Acquire ``border``
        gl.glCopyTexImage2D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value, ``border``.Value)
    override this.CopyTexSubImage2D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32) = 
        gl.glCopyTexSubImage2D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``x``, ``y``, ``width``, ``height``)
    override this.CopyTexSubImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>) = 
        this.Acquire ``target``
        this.Acquire ``level``
        this.Acquire ``xoffset``
        ...
        this.Acquire ``width``
        this.Acquire ``height``
        gl.glCopyTexSubImage2D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value)
    override this.CreateProgram(``returnValue`` : nativeptr<uint32>) = 
    ...
    override this.BlendColor(``red`` : float32, ``green`` : float32, ``blue`` : float32, ``alpha`` : float32) = 
        gl.glBlendColor.Invoke(``red``, ``green``, ``blue``, ``alpha``)
    override this.BlendColor(``red`` : aptr<float32>, ``green`` : aptr<float32>, ``blue`` : aptr<float32>, ``alpha`` : aptr<float32>) = 
        this.Acquire ``red``
        this.Acquire ``green``
        this.Acquire ``blue``
        this.Acquire ``alpha``
        gl.glBlendColor.Invoke(``red``.Value, ``green``.Value, ``blue``.Value, ``alpha``.Value)
    override this.BlendEquation(``mode`` : BlendEquationModeEXT) = 
    ...
    override this.SamplerParameterf(``sampler`` : uint32, ``pname`` : SamplerParameterF, ``param`` : float32) = 
        gl.glSamplerParameterf.Invoke(``sampler``, ``pname``, ``param``)
    override this.SamplerParameterf(``sampler`` : aptr<uint32>, ``pname`` : aptr<SamplerParameterF>, ``param`` : aptr<float32>) = 
        this.Acquire ``sampler``
        this.Acquire ``pname``
        this.Acquire ``param``
        gl.glSamplerParameterf.Invoke(``sampler``.Value, ``pname``.Value, ``param``.Value)
    override this.SamplerParameterfv(``sampler`` : uint32, ``pname`` : SamplerParameterF, ``param`` : nativeptr<float32>) = 
    ...
    override this.TexImage3D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``width`` : uint32, ``height`` : uint32, ``depth`` : uint32, ``border`` : int, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        gl.glTexImage3D.Invoke(``target``, ``level``, ``internalformat``, ``width``, ``height``, ``depth``, ``border``, ``format``, ``type``, ``pixels``)
    override this.TexImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``depth`` : aptr<uint32>, ``border`` : aptr<int>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<nativeint>) = 
        this.Acquire ``target``
        this.Acquire ``level``
        this.Acquire ``internalformat``
        ...
        this.Acquire ``type``
        this.Acquire ``pixels``
        gl.glTexImage3D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``width``.Value, ``height``.Value, ``depth``.Value, ``border``.Value, ``format``.Value, ``type``.Value, ``pixels``.Value)
    override this.TexStorage2D(``target`` : TextureTarget, ``levels`` : uint32, ``internalformat`` : SizedInternalFormat, ``width`` : uint32, ``height`` : uint32) = 
    ...
    override this.TexSubImage3D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``zoffset`` : int, ``width`` : uint32, ``height`` : uint32, ``depth`` : uint32, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        gl.glTexSubImage3D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``zoffset``, ``width``, ``height``, ``depth``, ``format``, ``type``, ``pixels``)
    override this.TexSubImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``zoffset`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``depth`` : aptr<uint32>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<nativeint>) = 
        this.Acquire ``target``
        this.Acquire ``level``
        this.Acquire ``xoffset``
        ...
        this.Acquire ``type``
        this.Acquire ``pixels``
        gl.glTexSubImage3D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``zoffset``.Value, ``width``.Value, ``height``.Value, ``depth``.Value, ``format``.Value, ``type``.Value, ``pixels``.Value)
    override this.GetTransformFeedbackVarying(``program`` : uint32, ``index`` : uint32, ``bufSize`` : uint32, ``length`` : nativeptr<uint32>, ``size`` : nativeptr<uint32>, ``type`` : nativeptr<AttributeType>, ``name`` : nativeptr<uint8>) = 
        gl.glGetTransformFeedbackVarying.Invoke(``program``, ``index``, ``bufSize``, ``length``, ``size``, ``type``, ``name``)
    override this.GetTransformFeedbackVarying(``program`` : aptr<uint32>, ``index`` : aptr<uint32>, ``bufSize`` : aptr<uint32>, ``length`` : aptr<uint32>, ``size`` : aptr<uint32>, ``type`` : aptr<AttributeType>, ``name`` : aptr<uint8>) = 
        this.Acquire ``program``
        this.Acquire ``index``
        this.Acquire ``bufSize``
        ...
        this.Acquire ``type``
        this.Acquire ``name``
        gl.glGetTransformFeedbackVarying.Invoke(``program``.Value, ``index``.Value, ``bufSize``.Value, NativePtr.ofNativeInt ``length``.Pointer, NativePtr.ofNativeInt ``size``.Pointer, NativePtr.ofNativeInt ``type``.Pointer, NativePtr.ofNativeInt ``name``.Pointer)
    override this.GetUniformuiv(``program`` : uint32, ``location`` : int, ``params`` : nativeptr<uint32>) = 
    ...
    override this.InvalidateSubFramebuffer(``target`` : FramebufferTarget, ``numAttachments`` : uint32, ``attachments`` : nativeptr<GLEnum>, ``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32) = 
        gl.glInvalidateSubFramebuffer.Invoke(``target``, ``numAttachments``, ``attachments``, ``x``, ``y``, ``width``, ``height``)
    override this.InvalidateSubFramebuffer(``target`` : aptr<FramebufferTarget>, ``numAttachments`` : aptr<uint32>, ``attachments`` : aptr<GLEnum>, ``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>) = 
        this.Acquire ``target``
        this.Acquire ``numAttachments``
        this.Acquire ``attachments``
        ...
        this.Acquire ``width``
        this.Acquire ``height``
        gl.glInvalidateSubFramebuffer.Invoke(``target``.Value, ``numAttachments``.Value, NativePtr.ofNativeInt ``attachments``.Pointer, ``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value)
    override this.IsQuery(``id`` : uint32, ``returnValue`` : nativeptr<Boolean>) = 
    ...
    override this.BlitFramebuffer(``srcX0`` : int, ``srcY0`` : int, ``srcX1`` : int, ``srcY1`` : int, ``dstX0`` : int, ``dstY0`` : int, ``dstX1`` : int, ``dstY1`` : int, ``mask`` : ClearBufferMask, ``filter`` : BlitFramebufferFilter) = 
        gl.glBlitFramebuffer.Invoke(``srcX0``, ``srcY0``, ``srcX1``, ``srcY1``, ``dstX0``, ``dstY0``, ``dstX1``, ``dstY1``, ``mask``, ``filter``)
    override this.BlitFramebuffer(``srcX0`` : aptr<int>, ``srcY0`` : aptr<int>, ``srcX1`` : aptr<int>, ``srcY1`` : aptr<int>, ``dstX0`` : aptr<int>, ``dstY0`` : aptr<int>, ``dstX1`` : aptr<int>, ``dstY1`` : aptr<int>, ``mask`` : aptr<ClearBufferMask>, ``filter`` : aptr<BlitFramebufferFilter>) = 
        this.Acquire ``srcX0``
        this.Acquire ``srcY0``
        this.Acquire ``srcX1``
        ...
        this.Acquire ``mask``
        this.Acquire ``filter``
        gl.glBlitFramebuffer.Invoke(``srcX0``.Value, ``srcY0``.Value, ``srcX1``.Value, ``srcY1``.Value, ``dstX0``.Value, ``dstY0``.Value, ``dstX1``.Value, ``dstY1``.Value, ``mask``.Value, ``filter``.Value)
    override this.ClearBufferiv(``buffer`` : BufferKind, ``drawbuffer`` : int, ``value`` : nativeptr<int>) = 
    ...
    override this.ClearBufferfi(``buffer`` : BufferKind, ``drawbuffer`` : int, ``depth`` : float32, ``stencil`` : int) = 
        gl.glClearBufferfi.Invoke(``buffer``, ``drawbuffer``, ``depth``, ``stencil``)
    override this.ClearBufferfi(``buffer`` : aptr<BufferKind>, ``drawbuffer`` : aptr<int>, ``depth`` : aptr<float32>, ``stencil`` : aptr<int>) = 
        this.Acquire ``buffer``
        this.Acquire ``drawbuffer``
        this.Acquire ``depth``
        this.Acquire ``stencil``
        gl.glClearBufferfi.Invoke(``buffer``.Value, ``drawbuffer``.Value, ``depth``.Value, ``stencil``.Value)
    override this.ClientWaitSync(``sync`` : nativeint, ``flags`` : SyncObjectMask, ``timeout`` : uint64, ``returnValue`` : nativeptr<GLEnum>) = 
    ...
    override this.CompressedTexImage3D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``width`` : uint32, ``height`` : uint32, ``depth`` : uint32, ``border`` : int, ``imageSize`` : uint32, ``data`` : nativeint) = 
        gl.glCompressedTexImage3D.Invoke(``target``, ``level``, ``internalformat``, ``width``, ``height``, ``depth``, ``border``, ``imageSize``, ``data``)
    override this.CompressedTexImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``depth`` : aptr<uint32>, ``border`` : aptr<int>, ``imageSize`` : aptr<uint32>, ``data`` : aptr<nativeint>) = 
        this.Acquire ``target``
        this.Acquire ``level``
        this.Acquire ``internalformat``
        ...
        this.Acquire ``imageSize``
        this.Acquire ``data``
        gl.glCompressedTexImage3D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``width``.Value, ``height``.Value, ``depth``.Value, ``border``.Value, ``imageSize``.Value, ``data``.Value)
    override this.CompressedTexSubImage3D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``zoffset`` : int, ``width`` : uint32, ``height`` : uint32, ``depth`` : uint32, ``format`` : InternalFormat, ``imageSize`` : uint32, ``data`` : nativeint) = 
        gl.glCompressedTexSubImage3D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``zoffset``, ``width``, ``height``, ``depth``, ``format``, ``imageSize``, ``data``)
    override this.CompressedTexSubImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``zoffset`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``depth`` : aptr<uint32>, ``format`` : aptr<InternalFormat>, ``imageSize`` : aptr<uint32>, ``data`` : aptr<nativeint>) = 
        this.Acquire ``target``
        this.Acquire ``level``
        this.Acquire ``xoffset``
        ...
        this.Acquire ``imageSize``
        this.Acquire ``data``
        gl.glCompressedTexSubImage3D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``zoffset``.Value, ``width``.Value, ``height``.Value, ``depth``.Value, ``format``.Value, ``imageSize``.Value, ``data``.Value)
    override this.CopyBufferSubData(``readTarget`` : CopyBufferSubDataTarget, ``writeTarget`` : CopyBufferSubDataTarget, ``readOffset`` : nativeint, ``writeOffset`` : nativeint, ``size`` : unativeint) = 
    ...
    override this.CopyTexSubImage3D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``zoffset`` : int, ``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32) = 
        gl.glCopyTexSubImage3D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``zoffset``, ``x``, ``y``, ``width``, ``height``)
    override this.CopyTexSubImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``zoffset`` : aptr<int>, ``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>) = 
        this.Acquire ``target``
        this.Acquire ``level``
        this.Acquire ``xoffset``
        ...
        this.Acquire ``width``
        this.Acquire ``height``
        gl.glCopyTexSubImage3D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``zoffset``.Value, ``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value)
    override this.DeleteQueries(``n`` : uint32, ``ids`` : nativeptr<uint32>) = 
...
type DebugCommandEncoder(device : Device) =
    ...
    override this.Uniform2iv(``location`` : aptr<int>, ``count`` : aptr<uint32>, ``value`` : aptr<int>) = 
        ...
        commands.Add((name, run))
    override this.Uniform3f(``location`` : int, ``v0`` : float32, ``v1`` : float32, ``v2`` : float32) = 
        let run() = gl.glUniform3f.Invoke(``location``, ``v0``, ``v1``, ``v2``)
    ...
    override this.Uniform3f(``location`` : aptr<int>, ``v0`` : aptr<float32>, ``v1`` : aptr<float32>, ``v2`` : aptr<float32>) = 
        ...
        let ``v1`` = this.Use ``v1``
        let ``v2`` = this.Use ``v2``
        let run() = gl.glUniform3f.Invoke(``location``.Value, ``v0``.Value, ``v1``.Value, ``v2``.Value)
    ...
    override this.Uniform3iv(``location`` : aptr<int>, ``count`` : aptr<uint32>, ``value`` : aptr<int>) = 
        ...
        commands.Add((name, run))
    override this.Uniform4f(``location`` : int, ``v0`` : float32, ``v1`` : float32, ``v2`` : float32, ``v3`` : float32) = 
        let run() = gl.glUniform4f.Invoke(``location``, ``v0``, ``v1``, ``v2``, ``v3``)
    ...
    override this.Uniform4f(``location`` : aptr<int>, ``v0`` : aptr<float32>, ``v1`` : aptr<float32>, ``v2`` : aptr<float32>, ``v3`` : aptr<float32>) = 
        ...
        let ``v2`` = this.Use ``v2``
        let ``v3`` = this.Use ``v3``
        let run() = gl.glUniform4f.Invoke(``location``.Value, ``v0``.Value, ``v1``.Value, ``v2``.Value, ``v3``.Value)
    ...
    override this.ValidateProgram(``program`` : aptr<uint32>) = 
        ...
        commands.Add((name, run))
    override this.VertexAttrib1f(``index`` : uint32, ``x`` : float32) = 
        let run() = gl.glVertexAttrib1f.Invoke(``index``, ``x``)
        let name() = sprintf "VertexAttrib1f(%A, %A)" ``index`` ``x``
        commands.Add((name, run))
    override this.VertexAttrib1f(``index`` : aptr<uint32>, ``x`` : aptr<float32>) = 
        let ``index`` = this.Use ``index``
        let ``x`` = this.Use ``x``
        let run() = gl.glVertexAttrib1f.Invoke(``index``.Value, ``x``.Value)
    ...
    override this.VertexAttrib1fv(``index`` : aptr<uint32>, ``v`` : aptr<float32>) = 
        ...
        commands.Add((name, run))
    override this.VertexAttrib2f(``index`` : uint32, ``x`` : float32, ``y`` : float32) = 
        let run() = gl.glVertexAttrib2f.Invoke(``index``, ``x``, ``y``)
    ...
    override this.VertexAttrib2f(``index`` : aptr<uint32>, ``x`` : aptr<float32>, ``y`` : aptr<float32>) = 
        ...
        let ``x`` = this.Use ``x``
        let ``y`` = this.Use ``y``
        let run() = gl.glVertexAttrib2f.Invoke(``index``.Value, ``x``.Value, ``y``.Value)
    ...
    override this.VertexAttrib2fv(``index`` : aptr<uint32>, ``v`` : aptr<float32>) = 
        ...
        commands.Add((name, run))
    override this.VertexAttrib3f(``index`` : uint32, ``x`` : float32, ``y`` : float32, ``z`` : float32) = 
        let run() = gl.glVertexAttrib3f.Invoke(``index``, ``x``, ``y``, ``z``)
    ...
    override this.VertexAttrib3f(``index`` : aptr<uint32>, ``x`` : aptr<float32>, ``y`` : aptr<float32>, ``z`` : aptr<float32>) = 
        ...
        let ``y`` = this.Use ``y``
        let ``z`` = this.Use ``z``
        let run() = gl.glVertexAttrib3f.Invoke(``index``.Value, ``x``.Value, ``y``.Value, ``z``.Value)
    ...
    override this.VertexAttrib3fv(``index`` : aptr<uint32>, ``v`` : aptr<float32>) = 
        ...
        commands.Add((name, run))
    override this.VertexAttrib4f(``index`` : uint32, ``x`` : float32, ``y`` : float32, ``z`` : float32, ``w`` : float32) = 
        let run() = gl.glVertexAttrib4f.Invoke(``index``, ``x``, ``y``, ``z``, ``w``)
    ...
    override this.VertexAttrib4f(``index`` : aptr<uint32>, ``x`` : aptr<float32>, ``y`` : aptr<float32>, ``z`` : aptr<float32>, ``w`` : aptr<float32>) = 
        ...
        let ``z`` = this.Use ``z``
        let ``w`` = this.Use ``w``
        let run() = gl.glVertexAttrib4f.Invoke(``index``.Value, ``x``.Value, ``y``.Value, ``z``.Value, ``w``.Value)
    ...
    override this.Viewport(``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>) = 
        ...
        commands.Add((name, run))
    override this.TexImage2D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``width`` : uint32, ``height`` : uint32, ``border`` : int, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        let run() = gl.glTexImage2D.Invoke(``target``, ``level``, ``internalformat``, ``width``, ``height``, ``border``, ``format``, ``type``, ``pixels``)
    ...
    override this.TexImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``border`` : aptr<int>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<nativeint>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``pixels`` = this.Use ``pixels``
        let run() = gl.glTexImage2D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``width``.Value, ``height``.Value, ``border``.Value, ``format``.Value, ``type``.Value, ``pixels``.Value)
        ...
        commands.Add((name, run))
    override this.TexParameterf(``target`` : TextureTarget, ``pname`` : TextureParameterName, ``param`` : float32) = 
        let run() = gl.glTexParameterf.Invoke(``target``, ``pname``, ``param``)
    ...
    override this.TexParameterf(``target`` : aptr<TextureTarget>, ``pname`` : aptr<TextureParameterName>, ``param`` : aptr<float32>) = 
        ...
        let ``pname`` = this.Use ``pname``
        let ``param`` = this.Use ``param``
        let run() = gl.glTexParameterf.Invoke(``target``.Value, ``pname``.Value, ``param``.Value)
    ...
    override this.TexParameteriv(``target`` : aptr<TextureTarget>, ``pname`` : aptr<TextureParameterName>, ``params`` : aptr<int>) = 
        ...
        commands.Add((name, run))
    override this.TexSubImage2D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``width`` : uint32, ``height`` : uint32, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        let run() = gl.glTexSubImage2D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``width``, ``height``, ``format``, ``type``, ``pixels``)
    ...
    override this.TexSubImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<nativeint>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``pixels`` = this.Use ``pixels``
        let run() = gl.glTexSubImage2D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``width``.Value, ``height``.Value, ``format``.Value, ``type``.Value, ``pixels``.Value)
        ...
        commands.Add((name, run))
    override this.Uniform1f(``location`` : int, ``v0`` : float32) = 
        let run() = gl.glUniform1f.Invoke(``location``, ``v0``)
        let name() = sprintf "Uniform1f(%A, %A)" ``location`` ``v0``
        commands.Add((name, run))
    override this.Uniform1f(``location`` : aptr<int>, ``v0`` : aptr<float32>) = 
        let ``location`` = this.Use ``location``
        let ``v0`` = this.Use ``v0``
        let run() = gl.glUniform1f.Invoke(``location``.Value, ``v0``.Value)
    ...
    override this.Uniform1iv(``location`` : aptr<int>, ``count`` : aptr<uint32>, ``value`` : aptr<int>) = 
        ...
        commands.Add((name, run))
    override this.Uniform2f(``location`` : int, ``v0`` : float32, ``v1`` : float32) = 
        let run() = gl.glUniform2f.Invoke(``location``, ``v0``, ``v1``)
    ...
    override this.Uniform2f(``location`` : aptr<int>, ``v0`` : aptr<float32>, ``v1`` : aptr<float32>) = 
        ...
        let ``v0`` = this.Use ``v0``
        let ``v1`` = this.Use ``v1``
        let run() = gl.glUniform2f.Invoke(``location``.Value, ``v0``.Value, ``v1``.Value)
    ...
    override this.Uniform2i(``location`` : aptr<int>, ``v0`` : aptr<int>, ``v1`` : aptr<int>) = 
        ...
        commands.Add((name, run))
    override this.ReadPixels(``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        let run() = gl.glReadPixels.Invoke(``x``, ``y``, ``width``, ``height``, ``format``, ``type``, ``pixels``)
    ...
    override this.ReadPixels(``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<'T7>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``pixels`` = this.Use ``pixels``
        let run() = gl.glReadPixels.Invoke(``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value, ``format``.Value, ``type``.Value, ``pixels``.Pointer)
    ...
    override this.RenderbufferStorage(``target`` : aptr<RenderbufferTarget>, ``internalformat`` : aptr<InternalFormat>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>) = 
        ...
        commands.Add((name, run))
    override this.SampleCoverage(``value`` : float32, ``invert`` : Boolean) = 
        let run() = gl.glSampleCoverage.Invoke(``value``, ``invert``)
        let name() = sprintf "SampleCoverage(%A, %A)" ``value`` ``invert``
        commands.Add((name, run))
    override this.SampleCoverage(``value`` : aptr<float32>, ``invert`` : aptr<Boolean>) = 
        let ``value`` = this.Use ``value``
        let ``invert`` = this.Use ``invert``
        let run() = gl.glSampleCoverage.Invoke(``value``.Value, ``invert``.Value)
    ...
    override this.IsTexture(``texture`` : aptr<uint32>, ``returnValue`` : aptr<Boolean>) = 
        ...
        commands.Add((name, run))
    override this.LineWidth(``width`` : float32) = 
        let run() = gl.glLineWidth.Invoke(``width``)
        let name() = sprintf "LineWidth(%A)" ``width``
        commands.Add((name, run))
    override this.LineWidth(``width`` : aptr<float32>) = 
        let ``width`` = this.Use ``width``
        let run() = gl.glLineWidth.Invoke(``width``.Value)
    ...
    override this.PixelStorei(``pname`` : aptr<PixelStoreParameter>, ``param`` : aptr<int>) = 
        ...
        commands.Add((name, run))
    override this.PolygonOffset(``factor`` : float32, ``units`` : float32) = 
        let run() = gl.glPolygonOffset.Invoke(``factor``, ``units``)
        let name() = sprintf "PolygonOffset(%A, %A)" ``factor`` ``units``
        commands.Add((name, run))
    override this.PolygonOffset(``factor`` : aptr<float32>, ``units`` : aptr<float32>) = 
        let ``factor`` = this.Use ``factor``
        let ``units`` = this.Use ``units``
        let run() = gl.glPolygonOffset.Invoke(``factor``.Value, ``units``.Value)
        let name() = sprintf "PolygonOffset(%A, %A)" (``factor``.Value) (``units``.Value)
        commands.Add((name, run))
    override this.GetActiveUniform(``program`` : uint32, ``index`` : uint32, ``bufSize`` : uint32, ``length`` : nativeptr<uint32>, ``size`` : nativeptr<int>, ``type`` : nativeptr<GLEnum>, ``name`` : nativeptr<uint8>) = 
        let run() = gl.glGetActiveUniform.Invoke(``program``, ``index``, ``bufSize``, ``length``, ``size``, ``type``, ``name``)
    ...
    override this.GetActiveUniform(``program`` : aptr<uint32>, ``index`` : aptr<uint32>, ``bufSize`` : aptr<uint32>, ``length`` : aptr<uint32>, ``size`` : aptr<int>, ``type`` : aptr<GLEnum>, ``name`` : aptr<uint8>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``name`` = this.Use ``name``
        let run() = gl.glGetActiveUniform.Invoke(``program``.Value, ``index``.Value, ``bufSize``.Value, NativePtr.ofNativeInt ``length``.Pointer, NativePtr.ofNativeInt ``size``.Pointer, NativePtr.ofNativeInt ``type``.Pointer, NativePtr.ofNativeInt ``name``.Pointer)
    ...
    override this.GetShaderiv(``shader`` : aptr<uint32>, ``pname`` : aptr<ShaderParameterName>, ``params`` : aptr<int>) = 
        ...
        commands.Add((name, run))
    override this.GetActiveAttrib(``program`` : uint32, ``index`` : uint32, ``bufSize`` : uint32, ``length`` : nativeptr<uint32>, ``size`` : nativeptr<int>, ``type`` : nativeptr<AttributeType>, ``name`` : nativeptr<uint8>) = 
        let run() = gl.glGetActiveAttrib.Invoke(``program``, ``index``, ``bufSize``, ``length``, ``size``, ``type``, ``name``)
    ...
    override this.GetActiveAttrib(``program`` : aptr<uint32>, ``index`` : aptr<uint32>, ``bufSize`` : aptr<uint32>, ``length`` : aptr<uint32>, ``size`` : aptr<int>, ``type`` : aptr<AttributeType>, ``name`` : aptr<uint8>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``name`` = this.Use ``name``
        let run() = gl.glGetActiveAttrib.Invoke(``program``.Value, ``index``.Value, ``bufSize``.Value, NativePtr.ofNativeInt ``length``.Pointer, NativePtr.ofNativeInt ``size``.Pointer, NativePtr.ofNativeInt ``type``.Pointer, NativePtr.ofNativeInt ``name``.Pointer)
    ...
    override this.DepthMask(``flag`` : aptr<Boolean>) = 
        ...
        commands.Add((name, run))
    override this.DepthRangef(``n`` : float32, ``f`` : float32) = 
        let run() = gl.glDepthRangef.Invoke(``n``, ``f``)
        let name() = sprintf "DepthRangef(%A, %A)" ``n`` ``f``
        commands.Add((name, run))
    override this.DepthRangef(``n`` : aptr<float32>, ``f`` : aptr<float32>) = 
        let ``n`` = this.Use ``n``
        let ``f`` = this.Use ``f``
        let run() = gl.glDepthRangef.Invoke(``n``.Value, ``f``.Value)
    ...
    override this.Clear(``mask`` : aptr<ClearBufferMask>) = 
        ...
        commands.Add((name, run))
    override this.ClearColor(``red`` : float32, ``green`` : float32, ``blue`` : float32, ``alpha`` : float32) = 
        let run() = gl.glClearColor.Invoke(``red``, ``green``, ``blue``, ``alpha``)
    ...
    override this.ClearColor(``red`` : aptr<float32>, ``green`` : aptr<float32>, ``blue`` : aptr<float32>, ``alpha`` : aptr<float32>) = 
        ...
        let ``blue`` = this.Use ``blue``
        let ``alpha`` = this.Use ``alpha``
        let run() = gl.glClearColor.Invoke(``red``.Value, ``green``.Value, ``blue``.Value, ``alpha``.Value)
        let name() = sprintf "ClearColor(%A, %A, %A, %A)" (``red``.Value) (``green``.Value) (``blue``.Value) (``alpha``.Value)
        commands.Add((name, run))
    override this.ClearDepthf(``d`` : float32) = 
        let run() = gl.glClearDepthf.Invoke(``d``)
        let name() = sprintf "ClearDepthf(%A)" ``d``
        commands.Add((name, run))
    override this.ClearDepthf(``d`` : aptr<float32>) = 
        let ``d`` = this.Use ``d``
        let run() = gl.glClearDepthf.Invoke(``d``.Value)
    ...
    override this.CompileShader(``shader`` : aptr<uint32>) = 
        ...
        commands.Add((name, run))
    override this.CompressedTexImage2D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``width`` : uint32, ``height`` : uint32, ``border`` : int, ``imageSize`` : uint32, ``data`` : nativeint) = 
        let run() = gl.glCompressedTexImage2D.Invoke(``target``, ``level``, ``internalformat``, ``width``, ``height``, ``border``, ``imageSize``, ``data``)
    ...
    override this.CompressedTexImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``border`` : aptr<int>, ``imageSize`` : aptr<uint32>, ``data`` : aptr<nativeint>) = 
        ...
        let ``imageSize`` = this.Use ``imageSize``
        let ``data`` = this.Use ``data``
        let run() = gl.glCompressedTexImage2D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``width``.Value, ``height``.Value, ``border``.Value, ``imageSize``.Value, ``data``.Value)
        ...
        commands.Add((name, run))
    override this.CompressedTexSubImage2D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``width`` : uint32, ``height`` : uint32, ``format`` : InternalFormat, ``imageSize`` : uint32, ``data`` : nativeint) = 
        let run() = gl.glCompressedTexSubImage2D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``width``, ``height``, ``format``, ``imageSize``, ``data``)
    ...
    override this.CompressedTexSubImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``format`` : aptr<InternalFormat>, ``imageSize`` : aptr<uint32>, ``data`` : aptr<nativeint>) = 
        ...
        let ``imageSize`` = this.Use ``imageSize``
        let ``data`` = this.Use ``data``
        let run() = gl.glCompressedTexSubImage2D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``width``.Value, ``height``.Value, ``format``.Value, ``imageSize``.Value, ``data``.Value)
        ...
        commands.Add((name, run))
    override this.CopyTexImage2D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32, ``border`` : int) = 
        let run() = gl.glCopyTexImage2D.Invoke(``target``, ``level``, ``internalformat``, ``x``, ``y``, ``width``, ``height``, ``border``)
    ...
    override this.CopyTexImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``border`` : aptr<int>) = 
        ...
        let ``height`` = this.Use ``height``
        let ``border`` = this.Use ``border``
        let run() = gl.glCopyTexImage2D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value, ``border``.Value)
        ...
        commands.Add((name, run))
    override this.CopyTexSubImage2D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32) = 
        let run() = gl.glCopyTexSubImage2D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``x``, ``y``, ``width``, ``height``)
    ...
    override this.CopyTexSubImage2D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>) = 
        ...
        let ``width`` = this.Use ``width``
        let ``height`` = this.Use ``height``
        let run() = gl.glCopyTexSubImage2D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value)
    ...
    override this.BindTexture(``target`` : aptr<TextureTarget>, ``texture`` : aptr<uint32>) = 
        ...
        commands.Add((name, run))
    override this.BlendColor(``red`` : float32, ``green`` : float32, ``blue`` : float32, ``alpha`` : float32) = 
        let run() = gl.glBlendColor.Invoke(``red``, ``green``, ``blue``, ``alpha``)
    ...
    override this.BlendColor(``red`` : aptr<float32>, ``green`` : aptr<float32>, ``blue`` : aptr<float32>, ``alpha`` : aptr<float32>) = 
        ...
        let ``blue`` = this.Use ``blue``
        let ``alpha`` = this.Use ``alpha``
        let run() = gl.glBlendColor.Invoke(``red``.Value, ``green``.Value, ``blue``.Value, ``alpha``.Value)
    ...
    override this.SamplerParameteriv(``sampler`` : aptr<uint32>, ``pname`` : aptr<SamplerParameterI>, ``param`` : aptr<int>) = 
        ...
        commands.Add((name, run))
    override this.SamplerParameterf(``sampler`` : uint32, ``pname`` : SamplerParameterF, ``param`` : float32) = 
        let run() = gl.glSamplerParameterf.Invoke(``sampler``, ``pname``, ``param``)
    ...
    override this.SamplerParameterf(``sampler`` : aptr<uint32>, ``pname`` : aptr<SamplerParameterF>, ``param`` : aptr<float32>) = 
        ...
        let ``pname`` = this.Use ``pname``
        let ``param`` = this.Use ``param``
        let run() = gl.glSamplerParameterf.Invoke(``sampler``.Value, ``pname``.Value, ``param``.Value)
    ...
    override this.SamplerParameterfv(``sampler`` : aptr<uint32>, ``pname`` : aptr<SamplerParameterF>, ``param`` : aptr<float32>) = 
        ...
        commands.Add((name, run))
    override this.TexImage3D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``width`` : uint32, ``height`` : uint32, ``depth`` : uint32, ``border`` : int, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        let run() = gl.glTexImage3D.Invoke(``target``, ``level``, ``internalformat``, ``width``, ``height``, ``depth``, ``border``, ``format``, ``type``, ``pixels``)
    ...
    override this.TexImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``depth`` : aptr<uint32>, ``border`` : aptr<int>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<nativeint>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``pixels`` = this.Use ``pixels``
        let run() = gl.glTexImage3D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``width``.Value, ``height``.Value, ``depth``.Value, ``border``.Value, ``format``.Value, ``type``.Value, ``pixels``.Value)
    ...
    override this.TexStorage3D(``target`` : aptr<TextureTarget>, ``levels`` : aptr<uint32>, ``internalformat`` : aptr<SizedInternalFormat>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``depth`` : aptr<uint32>) = 
        ...
        commands.Add((name, run))
    override this.TexSubImage3D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``zoffset`` : int, ``width`` : uint32, ``height`` : uint32, ``depth`` : uint32, ``format`` : PixelFormat, ``type`` : PixelType, ``pixels`` : nativeint) = 
        let run() = gl.glTexSubImage3D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``zoffset``, ``width``, ``height``, ``depth``, ``format``, ``type``, ``pixels``)
    ...
    override this.TexSubImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``zoffset`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``depth`` : aptr<uint32>, ``format`` : aptr<PixelFormat>, ``type`` : aptr<PixelType>, ``pixels`` : aptr<nativeint>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``pixels`` = this.Use ``pixels``
        let run() = gl.glTexSubImage3D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``zoffset``.Value, ``width``.Value, ``height``.Value, ``depth``.Value, ``format``.Value, ``type``.Value, ``pixels``.Value)
        ...
        commands.Add((name, run))
    override this.GetTransformFeedbackVarying(``program`` : uint32, ``index`` : uint32, ``bufSize`` : uint32, ``length`` : nativeptr<uint32>, ``size`` : nativeptr<uint32>, ``type`` : nativeptr<AttributeType>, ``name`` : nativeptr<uint8>) = 
        let run() = gl.glGetTransformFeedbackVarying.Invoke(``program``, ``index``, ``bufSize``, ``length``, ``size``, ``type``, ``name``)
    ...
    override this.GetTransformFeedbackVarying(``program`` : aptr<uint32>, ``index`` : aptr<uint32>, ``bufSize`` : aptr<uint32>, ``length`` : aptr<uint32>, ``size`` : aptr<uint32>, ``type`` : aptr<AttributeType>, ``name`` : aptr<uint8>) = 
        ...
        let ``type`` = this.Use ``type``
        let ``name`` = this.Use ``name``
        let run() = gl.glGetTransformFeedbackVarying.Invoke(``program``.Value, ``index``.Value, ``bufSize``.Value, NativePtr.ofNativeInt ``length``.Pointer, NativePtr.ofNativeInt ``size``.Pointer, NativePtr.ofNativeInt ``type``.Pointer, NativePtr.ofNativeInt ``name``.Pointer)
    ...
    override this.InvalidateFramebuffer(``target`` : aptr<FramebufferTarget>, ``numAttachments`` : aptr<uint32>, ``attachments`` : aptr<GLEnum>) = 
        ...
        commands.Add((name, run))
    override this.InvalidateSubFramebuffer(``target`` : FramebufferTarget, ``numAttachments`` : uint32, ``attachments`` : nativeptr<GLEnum>, ``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32) = 
        let run() = gl.glInvalidateSubFramebuffer.Invoke(``target``, ``numAttachments``, ``attachments``, ``x``, ``y``, ``width``, ``height``)
    ...
    override this.InvalidateSubFramebuffer(``target`` : aptr<FramebufferTarget>, ``numAttachments`` : aptr<uint32>, ``attachments`` : aptr<GLEnum>, ``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>) = 
        ...
        let ``width`` = this.Use ``width``
        let ``height`` = this.Use ``height``
        let run() = gl.glInvalidateSubFramebuffer.Invoke(``target``.Value, ``numAttachments``.Value, NativePtr.ofNativeInt ``attachments``.Pointer, ``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value)
    ...
    override this.BindVertexArray(``array`` : aptr<uint32>) = 
        ...
        commands.Add((name, run))
    override this.BlitFramebuffer(``srcX0`` : int, ``srcY0`` : int, ``srcX1`` : int, ``srcY1`` : int, ``dstX0`` : int, ``dstY0`` : int, ``dstX1`` : int, ``dstY1`` : int, ``mask`` : ClearBufferMask, ``filter`` : BlitFramebufferFilter) = 
        let run() = gl.glBlitFramebuffer.Invoke(``srcX0``, ``srcY0``, ``srcX1``, ``srcY1``, ``dstX0``, ``dstY0``, ``dstX1``, ``dstY1``, ``mask``, ``filter``)
    ...
    override this.BlitFramebuffer(``srcX0`` : aptr<int>, ``srcY0`` : aptr<int>, ``srcX1`` : aptr<int>, ``srcY1`` : aptr<int>, ``dstX0`` : aptr<int>, ``dstY0`` : aptr<int>, ``dstX1`` : aptr<int>, ``dstY1`` : aptr<int>, ``mask`` : aptr<ClearBufferMask>, ``filter`` : aptr<BlitFramebufferFilter>) = 
        ...
        let ``mask`` = this.Use ``mask``
        let ``filter`` = this.Use ``filter``
        let run() = gl.glBlitFramebuffer.Invoke(``srcX0``.Value, ``srcY0``.Value, ``srcX1``.Value, ``srcY1``.Value, ``dstX0``.Value, ``dstY0``.Value, ``dstX1``.Value, ``dstY1``.Value, ``mask``.Value, ``filter``.Value)
    ...
    override this.ClearBufferfv(``buffer`` : aptr<BufferKind>, ``drawbuffer`` : aptr<int>, ``value`` : aptr<float32>) = 
        ...
        commands.Add((name, run))
    override this.ClearBufferfi(``buffer`` : BufferKind, ``drawbuffer`` : int, ``depth`` : float32, ``stencil`` : int) = 
        let run() = gl.glClearBufferfi.Invoke(``buffer``, ``drawbuffer``, ``depth``, ``stencil``)
    ...
    override this.ClearBufferfi(``buffer`` : aptr<BufferKind>, ``drawbuffer`` : aptr<int>, ``depth`` : aptr<float32>, ``stencil`` : aptr<int>) = 
        ...
        let ``depth`` = this.Use ``depth``
        let ``stencil`` = this.Use ``stencil``
        let run() = gl.glClearBufferfi.Invoke(``buffer``.Value, ``drawbuffer``.Value, ``depth``.Value, ``stencil``.Value)
    ...
    override this.ClientWaitSync(``sync`` : aptr<nativeint>, ``flags`` : aptr<SyncObjectMask>, ``timeout`` : aptr<uint64>, ``returnValue`` : aptr<GLEnum>) = 
        ...
        commands.Add((name, run))
    override this.CompressedTexImage3D(``target`` : TextureTarget, ``level`` : int, ``internalformat`` : InternalFormat, ``width`` : uint32, ``height`` : uint32, ``depth`` : uint32, ``border`` : int, ``imageSize`` : uint32, ``data`` : nativeint) = 
        let run() = gl.glCompressedTexImage3D.Invoke(``target``, ``level``, ``internalformat``, ``width``, ``height``, ``depth``, ``border``, ``imageSize``, ``data``)
    ...
    override this.CompressedTexImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``internalformat`` : aptr<InternalFormat>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``depth`` : aptr<uint32>, ``border`` : aptr<int>, ``imageSize`` : aptr<uint32>, ``data`` : aptr<nativeint>) = 
        ...
        let ``imageSize`` = this.Use ``imageSize``
        let ``data`` = this.Use ``data``
        let run() = gl.glCompressedTexImage3D.Invoke(``target``.Value, ``level``.Value, ``internalformat``.Value, ``width``.Value, ``height``.Value, ``depth``.Value, ``border``.Value, ``imageSize``.Value, ``data``.Value)
        ...
        commands.Add((name, run))
    override this.CompressedTexSubImage3D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``zoffset`` : int, ``width`` : uint32, ``height`` : uint32, ``depth`` : uint32, ``format`` : InternalFormat, ``imageSize`` : uint32, ``data`` : nativeint) = 
        let run() = gl.glCompressedTexSubImage3D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``zoffset``, ``width``, ``height``, ``depth``, ``format``, ``imageSize``, ``data``)
    ...
    override this.CompressedTexSubImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``zoffset`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>, ``depth`` : aptr<uint32>, ``format`` : aptr<InternalFormat>, ``imageSize`` : aptr<uint32>, ``data`` : aptr<nativeint>) = 
        ...
        let ``imageSize`` = this.Use ``imageSize``
        let ``data`` = this.Use ``data``
        let run() = gl.glCompressedTexSubImage3D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``zoffset``.Value, ``width``.Value, ``height``.Value, ``depth``.Value, ``format``.Value, ``imageSize``.Value, ``data``.Value)
    ...
    override this.CopyBufferSubData(``readTarget`` : aptr<CopyBufferSubDataTarget>, ``writeTarget`` : aptr<CopyBufferSubDataTarget>, ``readOffset`` : aptr<nativeint>, ``writeOffset`` : aptr<nativeint>, ``size`` : aptr<unativeint>) = 
        ...
        commands.Add((name, run))
    override this.CopyTexSubImage3D(``target`` : TextureTarget, ``level`` : int, ``xoffset`` : int, ``yoffset`` : int, ``zoffset`` : int, ``x`` : int, ``y`` : int, ``width`` : uint32, ``height`` : uint32) = 
        let run() = gl.glCopyTexSubImage3D.Invoke(``target``, ``level``, ``xoffset``, ``yoffset``, ``zoffset``, ``x``, ``y``, ``width``, ``height``)
    ...
    override this.CopyTexSubImage3D(``target`` : aptr<TextureTarget>, ``level`` : aptr<int>, ``xoffset`` : aptr<int>, ``yoffset`` : aptr<int>, ``zoffset`` : aptr<int>, ``x`` : aptr<int>, ``y`` : aptr<int>, ``width`` : aptr<uint32>, ``height`` : aptr<uint32>) = 
        ...
        let ``width`` = this.Use ``width``
        let ``height`` = this.Use ``height``
        let run() = gl.glCopyTexSubImage3D.Invoke(``target``.Value, ``level``.Value, ``xoffset``.Value, ``yoffset``.Value, ``zoffset``.Value, ``x``.Value, ``y``.Value, ``width``.Value, ``height``.Value)
