...
let run() =
    ...
    do
        ...
        printfn "// ==============================================================================="
        printfn "//                    AUTO GENERATED FILE (see Generator.fsx)"
        printfn "// ==============================================================================="
    ...
    do 
        ...
        printfn "            run()"
        printfn "            let err = gl.GetError()"
        printfn "            if err <> GLEnum.NoError then"
        printfn "                Aardvark.Base.Report.Debug(\"ERROR: {0}\", err)"
        printfn "        if not o then"
        ...
        do
            ...
            printfn "#nowarn \"9\""
            printfn ""
            printfn "/// As of dotnet 8.0 the WebAssembly runtime does not support passing floats directly to C functions."
            printfn "/// This module provides a way to convert float32 values to int32 values that can be passed to C functions."
            printfn "module WrappedCommands ="
